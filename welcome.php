...
<div>
    <div class="row me-0 ms-0 pt-5" style="margin:10px;">
        ...
        <div class="col">
            <h3 class="mb-0" style="font-weight:bold;color: #0f5757;">Recent Documents</h3>
        </div>        
    </div>
    ...
    <div class="col-sm-12 col-md-12 col-lg-5 doc_card" style="border:1.5px solid #0f5757;min-height:80px; padding:5px;margin:5px;">
      <h4 style="margin-top:5px;">Sales Notices</h4>
      <p>Notice- Corrigendum to the expression of Interest (EOI) for procurement of Washery Rejects form IB Valley Non-coking coal washery of MCL.</p>
    </div>
    <div class="col-sm-12 col-md-12 col-lg-5 doc_card" style="border:1.5px solid #0f5757;min-height:80px;margin:5px;">
      <h4 style="margin-top:5px;">Guidelines</h4>
      <p>Guidelines for Mining Plan and Mine Closure Plan for Coal and Lignite blocks 2025.</p>
    </div>
</div>
<div class="row" style="margin-top:10px;">
    <div class="col-sm-12 col-md-12 col-lg-5 doc_card" style="border:1.5px solid #0f5757;min-height:80px; padding:5px;margin:5px;">
      <h4 style="margin-top:5px;">Manuals</h4>
      <p>User Manual to use ITSM Ticketing Tool(SOLMAN).</p>
    </div>
    <div class="col-sm-12 col-md-12 col-lg-5 doc_card" style="border:1.5px solid #0f5757;min-height:80px;margin:5px;">
      <h4 style="margin-top:5px;">ACTs</h4>
      <p>Coal Mines Nationalisation ACT 1973.</p>
    </div>
</div>
<div class="row" style="margin-top:10px;">
    <div align="right">
      <div style="display: inline-flex; align-items: center; border: 1.5px solid #0f5757; padding: 4px 8px;" class="doc_card">
  <h5 style="margin: 0;padding:5px;">View More</h5>
  <img src="resources/arrow_right.png" alt="ARROW RIGHT" style="width: 16px; height: 16px; margin-left: 6px;" />
        ...
        <div class="col">
            <h3 class="mb-0" style="font-weight:bold;color: #0f5757;">Important Links</h3>
        </div>        
    </div>
    <hr style="color: #0f5757;margin:5px;"/>
